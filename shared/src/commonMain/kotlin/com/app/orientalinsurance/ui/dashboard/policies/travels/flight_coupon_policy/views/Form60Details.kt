...
@Composable
fun Form60PersonalDetailScreen(
    flightViewModel: FlightViewModel,
    navHostController: NavHostController
) {

    val responseSaveData by flightViewModel.responseSaveData.collectAsState()
    var firstName by remember { mutableStateOf(flightViewModel.firstName ?: "") }
    var middleNmae by remember { mutableStateOf(flightViewModel.middleNmae ?: "") }
    var surName by remember { mutableStateOf(flightViewModel.surName ?: "") }
    var email by remember { mutableStateOf(flightViewModel.email60 ?: "") }
    var selectedDOB by remember { mutableStateOf(flightViewModel.selectedDOB ?: "") }

    var isClick by remember { mutableStateOf(false) }
    val isEnable by remember(firstName, surName, email, selectedDOB) {
        derivedStateOf {
            firstName.isNotBlank() && surName.isNotBlank() && email.isNotEmpty() && selectedDOB.isNotEmpty()
        }
    }
    ...
    Column(
        ...
        Button(
            ...
            onClick = {
                isClick = true
                navHostController.navigate(Form60Screen.Form60Father.rout)
            },
