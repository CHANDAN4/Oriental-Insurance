...
@Composable
fun FlightPersonalDetailsScreen(flightViewModel: FlightViewModel, navController: NavHostController) {

    var flightNo by remember { mutableStateOf("") }
    var airLineComp by remember { mutableStateOf("") }
    var selectedDateOfTravel by remember { mutableStateOf("") }
