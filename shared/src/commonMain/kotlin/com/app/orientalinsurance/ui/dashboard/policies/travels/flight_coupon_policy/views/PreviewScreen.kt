...
@Composable
fun PreviewScreen(flightViewModel: FlightViewModel, navController: NavHostController) {
        ...
        bottomBar = {
            Surface(
                ...
                Row(
                    ...
                    Button(
                        onClick = {
                            navController.navigate(Dashboards.DeclarationScreen.route)
                        },
                        modifier = Modifier
                            .width(150.dp)
                            .height(50.dp),
    ...
    if (policySummary) {
        ModalBottomSheet(
            ...
            PolicySummaryPreview(flightViewModel)
        }
    ...
    if (primumBreakup) {
        ModalBottomSheet(
            ...
            PremiumSummaryPreview(flightViewModel)
        }
...
@Composable
fun PremiumSummaryPreview(flightViewModel: FlightViewModel) {
...
@Composable
fun PolicySummaryPreview(flightViewModel: FlightViewModel) {
